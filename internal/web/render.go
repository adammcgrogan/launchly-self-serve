...
func (rd *Renderer) LoadAll(templates []domain.Template) error {
	...
	for _, p := range []string{"home", "pricing", "templates", "blog_index", "blog_post", "privacy", "terms", "dpa", "help", "help_custom_domain", "help_address", "help_switch_template", "help_appearance", "error", "claim", "paused"} {
	...
	for _, p := range []string{"sites", "new_site", "launched", "upgraded", "account", "accept_invite"} {
